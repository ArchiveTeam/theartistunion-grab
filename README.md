...
More information about the archiving project can be found on the ArchiveTeam wiki: [TheArtistUnion](https://www.archiveteam.org/index.php?title=The_Artist_Union)
...
Follow the [instructions on the ArchiveTeam wiki](http://archiveteam.org/index.php?title=Warrior) for installing the Warrior, and select the "TheArtistUnion" project in the Warrior interface.
